...
def demonstrate_tech_topic_english():
    ...
    print_section_header("AI-Powered LinkedIn Post Generator - Tech Topic Demo (Bengali)")
    ...
    try:
        ...
        generator = LinkedInPostGenerator(
            model_name="llama3.2:3b",  # Using better Ollama model for Bengali
    ...
    try:
        ...
        if response.success:
            ...
            # Save Bengali content to file for proper viewing
            bengali_file = os.path.join(os.path.dirname(__file__), '..', 'output', 'bengali_post_output.txt')
            ...
            print(f"\n📁 Bengali content saved to: {os.path.basename(bengali_file)}")
